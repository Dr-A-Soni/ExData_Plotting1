...
# 2) Generating the Plot3 

with(sub_Power, plot(sub_Power_datetime, sub_Power$Sub_metering_1, type="n", ylab="Energy sub metering", xlab=""))
with(sub_Power, points(sub_Power_datetime, sub_Power$Sub_metering_1, type="l"))
with(sub_Power, points(sub_Power_datetime, sub_Power$Sub_metering_2, type="l", col="red"))
with(sub_Power, points(sub_Power_datetime, sub_Power$Sub_metering_3, type="l", col="blue"))
legend("topright",
       col=c("black", "red", "blue"),
       lwd=1,
       legend=c("Sub_metering_1", "Sub_metering_2", "Sub_merering_3"))

# 3) Closing the Png device
dev.off()
